...
TextStyle getExtraLightStyle(
    {double fontSize = FontSize.s10, Color color = ColorsManager.offWhite}) {
  return _getTextStyle(fontSize, FontWeightManager.extraLight, color);
}

// light style
TextStyle getLightStyle(
    {double fontSize = FontSize.s12, Color color = ColorsManager.offWhite}) {
  return _getTextStyle(fontSize, FontWeightManager.light, color);
}

// regular style
TextStyle getRegularStyle(
    {double fontSize = FontSize.s14, Color color = ColorsManager.offWhite}) {
  return _getTextStyle(fontSize, FontWeightManager.regular, color);
}

// medium style
TextStyle getMediumStyle(
    {double fontSize = FontSize.s16, Color color = ColorsManager.offWhite}) {
