...
class SuggestionTripReserveScreen extends StatefulWidget {
  const SuggestionTripReserveScreen(
      {super.key, required this.suggestionTripModel});

  final SuggestionTripModel suggestionTripModel;

  @override
  State<SuggestionTripReserveScreen> createState() =>
      _SuggestionTripReserveScreenState();
}

class _SuggestionTripReserveScreenState
    extends State<SuggestionTripReserveScreen> {
  @override
  void initState() {
    super.initState();
    context.read<PasswordIconCubit>().forceClose();
    context.read<TripSeatsCubit>().getTripSeats(
          widget.suggestionTripModel.id!.toString(),
        );
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              TicketFromToSection(
                startCity: widget.suggestionTripModel.from!,
                endCity: widget.suggestionTripModel.to!,
                date: getFormattedDateFromString(
                    widget.suggestionTripModel.startTime),
                startTime: getFormattedTimeFromString(
                    widget.suggestionTripModel.startTime),
                endTime: getFormattedTimeFromString(
                    widget.suggestionTripModel.arrivalTime),
              ),
              VerticalSpace(20),
              SizedBox(
                height: 600,
                            ...
                            onPressed: () async {
                              ...
                              context
                                  ...
                                  .requestOrgTrip(OrgTripReserveRequest(
                                      ...
                                      tripId: widget.suggestionTripModel.id!,
                                      seats: reversedSeats
                                          .map((e) => Seats(
                                              seatNum: e,
                                              qrCodeFile: null,
