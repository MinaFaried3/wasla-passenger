    ...
    return Stack(
      ...
      children: [
        CupertinoSwitch(
          ...
          thumbColor:
              active ? ColorsManager.offWhite300 : ColorsManager.tealPrimary800,
          ...
          onChanged: (val) {
            ...
            if (val)
              context.read<TripSearchCubit>().onChangeTime(DateTime.now());
            else
              context.read<TripSearchCubit>().removeTime();
          },
        ),
        if (active)
          SectionWithTitle(
            ...
            content: Directionality(
              ...
              child: TimePickerSpinner(
                ...
                spacing: 5,
                onTimeChange: (time) {
                  context.read<TripSearchCubit>().onChangeTime(time);
        ...
        if (!active)
          SectionTitle(
            title: AppStrings.takeOffTime.tr(),
            iconPath: AssetsProvider.clockIcon,
          ),
      ],
    );
